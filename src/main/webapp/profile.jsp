								...
								<div class="profile-header">
									<div class="cover-container text-center">
										...
										<div class="profile-detail mt-3">
											...
											<p>Phasellus faucibus mollis pharetra. Proin blandit ac
												massa.Morbi nulla dolor, ornare at commodo non, feugiat non
												nisi.</p>
										</div>
										...
										<ul class="list-inline p-0 mb-0">
											<li class="d-flex mb-4 align-items-center">
												...
												<div class="iq-card-toolbar">
													<div class="dropdown">
														<span class="font-size-24" id="dropdownMenuButton01"
														...
														<div class="dropdown-menu dropdown-menu-right p-0"
															...
															<a class="dropdown-item" href="#"><i
																class="ri-user-unfollow-line mr-2"></i>Share</a> <a
											...
											<li class="d-flex mb-4 align-items-center">
												...
												<div class="iq-card-toolbar">
													<div class="dropdown">
														<span class="font-size-24" id="dropdownMenuButton02"
															data-toggle="dropdown" aria-expanded="false"> <i
															class="ri-more-line"></i>
														</span>
														<div class="dropdown-menu dropdown-menu-right p-0"
											...
											<li class="d-flex mb-4 align-items-center">
												...
												<div class="iq-card-toolbar">
													<div class="dropdown">
														<span class="font-size-24" id="dropdownMenuButton03"
															data-toggle="dropdown" aria-expanded="false"> <i
															class="ri-more-line"></i>
														</span>
														<div class="dropdown-menu dropdown-menu-right p-0"
											...
											<li class="d-flex mb-4 align-items-center">
												...
												<div class="iq-card-toolbar">
													<div class="dropdown">
														<span class="font-size-24" id="dropdownMenuButton04"
															data-toggle="dropdown" aria-expanded="false"> <i
															class="ri-more-line"></i>
														</span>
														<div class="dropdown-menu dropdown-menu-right p-0"
											...
											<li class="d-flex align-items-center">
												...
												<div class="iq-card-toolbar">
													<div class="dropdown">
														<span class="font-size-24" id="dropdownMenuButton05"
															data-toggle="dropdown" aria-expanded="false"> <i
															class="ri-more-line"></i>
														</span>
														<div class="dropdown-menu dropdown-menu-right p-0"
