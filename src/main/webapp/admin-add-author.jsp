                  ...
                  <ul id="iq-sidebar-toggle" class="iq-menu">
                     ...
                     <li class="active active-menu">
                        ...
                        <ul id="admin" class="iq-submenu collapse show" data-parent="#iq-sidebar-toggle">
                           ...
                           <li class="active"><a href="admin-book.jsp"><i class="ri-file-pdf-line"></i>Books</a></li>
                        </ul>
                     </li>
                  ...
                  <div class="col-sm-12">
                     <div class="iq-card">
                        ...
                        <div class="iq-card-body">
                           <form action="https://templates.iqonic.design/booksto/html-dark/admin-author.html">
